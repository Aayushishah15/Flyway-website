<%@ Page Title="RoundTrip" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Roundtrip.aspx.cs" Inherits="MajorProject.Roundtrip" %>
 ...
 <div id="booking" class="section">
		<div class="section-center">
			...
			<div class="container" id="Roundtrip">
				<div class="row">
                <h1 class="header-w3ls">Round Way </h1>
						...
						<form>
							<div class="form-group">
								<div class="form-checkbox">
                                    ...
                                    <label for="roundtrip">
										<input type="radio" id="Radio2" name="flight-type" checked>
										<span></span>Roundtrip
									</label>
									<label for="multi-city">
										<input type="radio" id="Radio3" name="flight-type">
								...
								<div class="col-md-6">
									<div class="form-group">
                                        ...
                                        <asp:DropDownList ID="DropDownList1" runat="server" 
                                            DataSourceID="SqlDataSource1" DataTextField="City1" DataValueField="City1" class="form-control">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<asp:DropDownList ID="DropDownList2" runat="server" 
                                            DataSourceID="SqlDataSource2" DataTextField="City2" DataValueField="City2" class="form-control" >
                       <asp:ListItem Value="">Destination Country</asp:ListItem>                
                           <asp:ListItem>Mumbai</asp:ListItem>
                            <asp:ListItem>Goa</asp:ListItem>
                            <asp:ListItem>Kolkata</asp:ListItem>
							...
							<div class="row">
								...
								<div class="col-md-3">
									<div class="form-group">
                                        ...
                                        <asp:TextBox ID="TextBox2" runat="server" class="form-control" type="date" required></asp:TextBox>	</div>
								</div>
								<div class="col-md-2">
									<div class="form-group">
                            ...
                            <asp:ListItem>Premium Class</asp:ListItem>
                                ...
                                <div class="col-md-3">
									<div class="form-group">
										<span class="form-label">Returning Travel class</span>
                            ...
                            <asp:ListItem>Premium Class</asp:ListItem>
								...
								<div class="col-md-3">
									<div class="form-btn">
                                        <asp:Button ID="Button1" runat="server" Text="Show flights" onclick="Button1_Click" />
...
<div align="center">
    <asp:DataList ID="DataList1" runat="server" DataKeyField="id" CellSpacing="200"
        DataSourceID="SqlDataSource3"  Height="378px" Width="866px" RepeatColumns="2" 
        ...
        <ItemTemplate>
          ...
          2nd Trip:-
            <br />
              <asp:Label ID="Label2" runat="server" Text='<%# Eval("City2") %>' /> To <asp:Label ID="Label1" runat="server" Text='<%# Eval("City1") %>' /> 
          </h4>
           <h4>
           <asp:Label ID="Label4" runat="server" Text='<%# Eval("State2") %>' /> To  <asp:Label ID="Label3" runat="server" Text='<%# Eval("State1") %>' />
            </h4>
...
<br />
            <asp:LinkButton ID="LinkButton2" runat="server" class="btn btn-warning" onclick="LinkButton2_Click">Book Now</asp:LinkButton>
