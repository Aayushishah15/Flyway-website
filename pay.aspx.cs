...
namespace MajorProject
{
    public partial class pay : System.Web.UI.Page
    {
        ...
        protected void showbill()
        {
            ...
            SqlCommand cmd = new SqlCommand(" SELECT sum( [price] + m.[charges]  + m.[adults]) FROM [city] p,[oneway] c ,[bokkingcharg] m  where p.[ID] = c.pid and c.email = '" + email + "'", cn);
        ...
        protected void CheckBox1_CheckedChanged1(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("insert into finalbill (bill,email,pid,status,oid)Values(@bill,@email,@pid,'oneway',@oid)", cn);
