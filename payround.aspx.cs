...
{
    public partial class payround : System.Web.UI.Page
    {
        static int number = 0;
        ...
        protected void showbill()
        {
            ...
            SqlCommand cmd = new SqlCommand(" SELECT sum( [price] + m.[charges]  + m.[adults]) FROM [city] p,[roundtrip] c ,[bokkingcharg] m  where p.[ID] = c.pid and c.email = '" + email + "'", cn);
        ...
        protected void CheckBox1_CheckedChanged(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("insert into finalbill (bill,email,pid,date,status,oid)Values(@bill,@email,@pid,@date,'Roundtrip',@oid)", cn);
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("delete from oneway where email='" + Session["email"] + "' ", cn);
            cn.Open();
            cmd.ExecuteNonQuery();
            cn.Close();
