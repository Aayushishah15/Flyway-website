<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AddHotels.aspx.cs" Inherits="MajorProject.AddProducts" %>
      ...
      <div class="row">
        <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
            <div class="row">
              <div class="col-12">
                <h2 class="tm-block-title d-inline-block">Add Hotels</h2>
              </div>
            </div>
        ...
        <asp:TextBox ID="TextBox1" runat="server"  class="form-control validate"></asp:TextBox>
                  ...
                  <div class="form-group mb-3">
                   <label for="description">Enter State</label>
            ...
            <asp:TextBox ID="TextBox3" runat="server"  class="form-control validate"></asp:TextBox>
             ...
             <asp:LinkButton ID="LinkButton1" runat="server" onclick="LinkButton1_Click"
                                             class="btn btn-primary btn-block text-uppercase" >Add Hotel</asp:LinkButton></div>
